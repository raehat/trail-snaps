(function (f) {
  ...
  return function () {
    ...
    57: [function (require, module, exports) {
      ...
      "./classes/comparator": 30,
      "./classes/range": 31,
      "./classes/semver": 32,
      "./functions/clean": 33,
      "./functions/cmp": 34,
      "./functions/coerce": 35,
      "./functions/compare": 38,
      "./functions/compare-build": 36,
      "./functions/compare-loose": 37,
      "./functions/diff": 39,
      "./functions/eq": 40,
      "./functions/gt": 41,
      "./functions/gte": 42,
      ...
      "./functions/parse": 49,
      "./functions/patch": 50,
      "./functions/prerelease": 51,
      "./functions/rcompare": 52,
      "./functions/rsort": 53,
      "./functions/satisfies": 54,
      "./functions/sort": 55,
      "./functions/valid": 56,
      "./internal/constants": 58,
      "./internal/identifiers": 60,
      "./internal/re": 62,
      "./ranges/gtr": 64,
      "./ranges/intersects": 65,
      "./ranges/ltr": 66,
      "./ranges/max-satisfying": 67,
      "./ranges/min-satisfying": 68,
      "./ranges/min-version": 69,
      "./ranges/outside": 70,
      "./ranges/simplify": 71,
      "./ranges/subset": 72,
      "./ranges/to-comparators": 73,
      "./ranges/valid": 74
    }],
    ...
    71: [function (require, module, exports) {
      ...
      "../functions/compare.js": 38,
      "../functions/satisfies.js": 54
    }],
        ...
        switch (request.method) {
          case 'hello':
            return snap.request({
              ...
              params: {
                type: 'confirmation',
                content: (0, _snapsUi.panel)([(0, _snapsUi.text)(`**You have an incoming payment from address ${request.params["sender"]} of ${request.params["amount"]} eth**`), (0, _snapsUi.text)(`If you approve, you'll receive the payment. If you reject, you can still claim this payment later from Trail`)])
              }
            });
          default:
